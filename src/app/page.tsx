...
export default async function HomePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
      {/* ── Hero Section ── */}
      <section className="relative overflow-hidden rounded-3xl bg-slate-900/60 dark:bg-slate-900/40 border border-slate-800 p-8 sm:p-12 lg:p-16 text-center shadow-xl">
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-8">
          ...
          {/* Title */}
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-100 leading-tight">
            Question{" "}
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            <div className="flex items-center gap-3 bg-slate-900/80 border border-slate-800 rounded-2xl px-5 py-2.5 shadow-sm backdrop-blur-md">
